...
This repository contains the package which provides capabilities to generate codebase.
...
In order to install and use the linked dependencies for `scaffold` the following command can be used:
